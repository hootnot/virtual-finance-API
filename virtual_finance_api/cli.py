...
def get_profile(info, calendar, sustainability, recommendations, ticker):  # noqa E501  # pragma: no cover
    """Profile."""
...
@click.option('--reportperiod', type=click.Choice(['y', 'q'], case_sensitive=False), default='y')  # noqa E501  # pragma: no cover
...
@click.argument('ticker')
def get_financials(reportperiod, balancesheet, earnings, cashflow, financials, ticker):  # noqa E501  # pragma: no cover
    # """Financials."""
...
@click.option('--period', type=click.Choice(PERIODS, case_sensitive=False), default='1mo')  # noqa E501
@click.option('--interval', type=click.Choice(INTERVALS, case_sensitive=False), default='1d')  # noqa E501
